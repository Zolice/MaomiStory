<template>
    <div class="bg-black/25 flex flex-col justify-evenly place-items-center w-[200px] h-[210px] p-2 text-center rounded-lg">
        ...
        <p class="text-white font-light font-outfit w-full line-clamp-2 mb-2">
            Legendary Arcaneshade Weapon Box with long name
        </p>
